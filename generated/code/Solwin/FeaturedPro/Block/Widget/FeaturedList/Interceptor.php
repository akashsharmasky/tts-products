<?php
namespace Solwin\FeaturedPro\Block\Widget\FeaturedList;

/**
 * Interceptor class for @see \Solwin\FeaturedPro\Block\Widget\FeaturedList
 */
class Interceptor extends \Solwin\FeaturedPro\Block\Widget\FeaturedList implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\Data\Helper\PostHelper $postDataHelper, \Magento\Catalog\Model\Layer\Resolver $layerResolver, \Magento\Catalog\Api\CategoryRepositoryInterface $categoryRepository, \Magento\Framework\Url\Helper\Data $urlHelper, \Magento\Catalog\Model\ResourceModel\Product\Collection $collection, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $postDataHelper, $layerResolver, $categoryRepository, $urlHelper, $collection, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImageHelper');
        if (!$pluginInfo) {
            return parent::getImageHelper();
        } else {
            return $this->___callPlugins('getImageHelper', func_get_args(), $pluginInfo);
        }
    }
