...
class Interceptor extends \Mirasvit\Blog\Model\ResourceModel\Post implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCategoryIds($post)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCategoryIds($post);
        } else {
    ...
    public function getStoreIds($post)
    {
        ...
        if (!$pluginInfo) {
            return parent::getStoreIds($post);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTagIds');
        if (!$pluginInfo) {
            return parent::getTagIds($post);
        } else {
            return $this->___callPlugins('getTagIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductIds($post)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductIds($post);
        } else {
